...
# from utils.nn.tit import *
# from utils.util import Swish,PositionEncode2D,PositionEncode1D
# from utils.nn.transformer import *

from utils.network_model.tit import *
from utils.util import Swish,PositionEncode2D,PositionEncode1D
...
class Net(torch.nn.Module):
    ...
    def forward_argmax_decode(self, image):
        ...
        image_embed = self.image_encode(image_embed) # v1 修正
        # b*n 填充 <pad>con
...
def run_check_net():
    ...
    net = Net()
    "00922000_model.pth"
    f = torch.load(r"F:\BMS_Translation\src\utils\pretrain_model\00922000_model.pth", map_location=lambda storage, loc: storage)
